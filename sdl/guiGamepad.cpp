...
void loadInstruct(void)
{
  ...
  instructDpadText = TTF_RenderText_Blended(instructFont, "to select game", instructTextColor);
  instructButtonText = TTF_RenderText_Blended(instructFont, "Press       to Start", instructTextColor);
  instructText[0] = TTF_RenderText_Blended(instructFont, "PLEASE CONNECT", instructTextColor);
  instructText[1] = TTF_RenderText_Blended(instructFont, "PLAYER 1 GAMEPAD", instructTextColor);
}
