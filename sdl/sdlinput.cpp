...
// AWH - These were 6 and 7, rather than 4 and 5
...
//fprintf(stderr, "SDL_JOYAXISMOTION: beagleSNESDeviceMap[event.jaxis.which] -> %d\n", beagleSNESDeviceMap[event.jaxis.which]);
